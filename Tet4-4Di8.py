...
# Benzene as linker 
bb1 = stk.BuildingBlock('Nc1ccc(N)cc1',[stk.PrimaryAminoFactory()]) 

# Construct cage structure
cage = stk.ConstructedMolecule(
    topology_graph=stk.cage.FourPlusEight(building_blocks=(Zr_atom, bb1),optimizer=stk.Collapser(step_size=0.01, distance_threshold=5)),
)
 
# Write to file
writer = stk.PdbWriter()
writer.write(molecule=cage, path='base_structure/Tet4-4Di8.pdb')
...
cage = read("base_structure/Tet4-4Di8.pdb")
