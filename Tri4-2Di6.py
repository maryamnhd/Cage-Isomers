...
cage = stk.ConstructedMolecule(
    topology_graph=stk.cage.FourPlusSix2(building_blocks=(Zr_atom, bb1),optimizer=stk.Collapser(step_size=0.01, distance_threshold=5)),   
)

# Write to file
writer = stk.PdbWriter()
writer.write(molecule=cage, path='base_structure/Tri4-2Di6.pdb')
...
cage = read("base_structure/Tri4-2Di6.pdb")
