...
cage = stk.ConstructedMolecule(
    topology_graph=stk.cage.M24L48(building_blocks=(Zr_atom, bb1),optimizer=stk.Collapser(step_size=1, distance_threshold=20)),   #, distance_threshold=5
)
 

# Write to file
writer = stk.PdbWriter()
writer.write(molecule=cage, path='base_structure/Tet24Di48.pdb')
...
cage = read("base_structure/Tet24Di48.pdb")
