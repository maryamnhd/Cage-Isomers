...
cage = stk.ConstructedMolecule(
    topology_graph=stk.cage.EightPlusTwelve(building_blocks=(Zr_atom, bb1),optimizer=stk.Collapser(step_size=0.01, distance_threshold=5)),   
)

# Write to file
writer = stk.PdbWriter()
writer.write(molecule=cage, path='base_structure/Tri8Di12.pdb')
...
cage = read("base_structure/Tri8Di12.pdb")
